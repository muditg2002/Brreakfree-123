...
export default function Onboarding() {
  ...
  const { setUser, user, isLoaded } = useAppState();
  ...
  const renderStep = () => {
    switch (steps[currentStep]) {
      case 'landing':
        return (
          ...
          >
            ...
            <h1 className="text-4xl mb-4 text-zinc-100">Trying to stop betting… but keep going back?</h1>
      ...
      case 'identity':
        ...
        return (
          <div className="p-8 flex flex-col h-full">
            <h2 className="text-2xl mb-8 text-zinc-100">Which one feels most like you?</h2>
      ...
      case 'loss':
        ...
        return (
          <div className="p-8 flex flex-col h-full">
            <h2 className="text-2xl mb-2 text-zinc-100">How much do you roughly lose per week?</h2>
      ...
      case 'triggers':
        ...
        return (
          <div className="p-8 flex flex-col h-full">
            <h2 className="text-2xl mb-8 text-zinc-100">When are you most likely to bet?</h2>
      ...
      case 'reason':
        ...
        return (
          <div className="p-8 flex flex-col h-full">
            <h2 className="text-2xl mb-8 text-zinc-100">Why do you want to stop?</h2>
            <div className="space-y-4 flex-1">
              {reasons.map(reason => (
                <button
                  key={reason}
      ...
      case 'pledge':
        return (
          <div className="p-8 flex flex-col h-full">
            <h2 className="text-2xl mb-4 text-zinc-100">Record a message to yourself</h2>
      ...
      case 'urge-intro':
        return (
          <div className="p-8 flex flex-col h-full items-center justify-center text-center">
            ...
            <h2 className="text-3xl mb-4 text-zinc-100">I feel like betting</h2>
      ...
      case 'account':
        return (
          <div className="p-8 flex flex-col h-full items-center justify-center text-center">
            ...
            <h2 className="text-3xl mb-4 text-zinc-100">Save your progress</h2>
...
function PracticeMode({ onComplete }: { onComplete: () => void }) {
  ...
  if (stage === 'countdown') {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
        ...
        <p className="text-2xl text-zinc-100">Pause. Don't act.</p>
      </div>
    );
  }
  ...
  if (stage === 'calm') {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
        <h2 className="text-3xl mb-8 text-zinc-100">Take a deep breath.</h2>
        <motion.div 
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center">
      ...
      <h2 className="text-3xl mb-4 text-zinc-100">First micro-win!</h2>
