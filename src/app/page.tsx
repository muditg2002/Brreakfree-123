...
export default function Home() {
  const { user, urges, relapses, isLoaded } = useAppState();
    ...
    <div className="flex-1 flex flex-col p-6 space-y-8 overflow-y-auto pb-24">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-xl text-zinc-100">Pause</span>
        </div>
        <button onClick={() => router.push('/stats')} className="p-2 text-zinc-500 hover:text-zinc-100 transition-colors">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <span className="text-sm font-medium text-zinc-100">Log relapse</span>
          </button>
          <button 
          ...
          >
            ...
            <span className="text-sm font-medium text-zinc-100">Watch pledge</span>
          </button>
          <button 
            onClick={() => router.push('/sos-setup')}
            className="glass-card p-4 flex items-center gap-3 hover:bg-white/10 transition-colors"
          >
            <Settings className="w-5 h-5 text-zinc-400" />
            <span className="text-sm font-medium text-zinc-100">SOS Support</span>
          </button>
          <button 
